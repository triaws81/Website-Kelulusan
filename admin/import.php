...
<body>
<h3>Import Data dari File Excel</h3>
<div class="well">
<form method="post" enctype="multipart/form-data" action="index.php?page=proses-import">
...
download contoh file excel <a href="contoh-data.xls">Download</a> <br>
